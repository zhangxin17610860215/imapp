package com.wulewan.ghxm.chatroom.adapter;
...
import com.wulewan.ghxm.chatroom.widget.ChatRoomImageView;
...
public class ChatRoomOnlinePeopleAdapter extends BaseQuickAdapter<ChatRoomMember, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder holder, ChatRoomMember member, int position, boolean isScrolling) {
        // bg selector
        holder.getConvertView().setBackgroundResource(com.netease.wulewan.uikit.R.drawable.nim_touch_bg);
