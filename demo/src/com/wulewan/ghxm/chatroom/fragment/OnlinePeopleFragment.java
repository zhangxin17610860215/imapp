package com.wulewan.ghxm.chatroom.fragment;
...
import com.wulewan.ghxm.chatroom.activity.ChatRoomActivity;
import com.wulewan.ghxm.chatroom.adapter.ChatRoomOnlinePeopleAdapter;
import com.netease.wulewan.uikit.api.NimUIKit;
import com.netease.wulewan.uikit.api.model.SimpleCallback;
import com.netease.wulewan.uikit.api.model.chatroom.RoomMemberChangedObserver;
...
import com.netease.wulewan.uikit.common.ui.ptr2.PullToRefreshLayout;
    ...
    private void addTempMuteItemNotify(final ChatRoomMember chatRoomMember, CustomAlertDialog alertDialog) {
        alertDialog.addItem(R.string.set_temp_mute_notify, new CustomAlertDialog.onSeparateItemClickListener() {
            ...
            public void onClick() {
                ...
                Dialog dialog = EasyAlertDialogHelper.showCommonDialogWithEdit(getActivity(), R.string.mute_duration, "发送", "取消", true, new EasyAlertDialogHelper.OnDialogWithEditActionListener() {
                    @Override
                    ...
                    @Override
                    public void doOkAction(String content) {
                ...
                Dialog dialog = EasyAlertDialogHelper.showCommonDialogWithEdit(getActivity(), R.string.mute_duration, "发送", "取消", true, new EasyAlertDialogHelper.OnDialogWithEditActionListener() {
                    ...
                    public void doOkAction(String text) {
                        ...
                        if (!TextUtils.isEmpty(text)) {
                            setTempMute(chatRoomMember.getAccount(), text, false);
                        }
                        getActivity().getWindow().setSoftInputMode(
                                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
