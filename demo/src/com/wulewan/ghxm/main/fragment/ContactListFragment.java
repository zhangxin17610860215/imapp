...
import com.netease.wulewan.uikit.business.contact.ContactsFragment;
...
import com.wulewan.ghxm.main.viewholder.FuncViewHolder;
...
public class ContactListFragment extends MainTabFragment {
    ...
    public boolean loadRealLayout() {
        ...
        if (root != null) {
            ...
            View.inflate(root.getContext(), R.layout.contacts_list, root);
        }
        return root != null;
    }
