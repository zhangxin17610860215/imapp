...
import com.wulewan.ghxm.location.adapter.IconListAdapter;
import com.wulewan.ghxm.location.adapter.IconListAdapter.IconListItem;
import com.wulewan.ghxm.location.helper.MapHelper;
...
//        setToolBar(R.id.toolbar, options);
        onInitSetBack(this);
        onInitRightSure(this, 0, getString(R.string.location_navigate), 0);
...
//            setTitle(R.string.location_loading);
            onInitSetTitle(this, getString(R.string.location_loading));
            comRightSure.setVisibility(View.GONE);
        } else {
//            setTitle(R.string.location_map);
            onInitSetTitle(this, getString(R.string.location_map));
            comRightSure.setVisibility(View.GONE);
        }
    }
