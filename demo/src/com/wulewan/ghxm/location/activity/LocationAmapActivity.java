package com.wulewan.ghxm.location.activity;
...
import com.wulewan.ghxm.location.helper.NimGeocoder;
import com.wulewan.ghxm.location.helper.NimLocationManager;
import com.wulewan.ghxm.location.helper.NimLocationManager.NimLocationListener;
import com.wulewan.ghxm.location.model.NimLocation;
...
//    private TextView sendButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mapView = findView(R.id.autonavi_mapView);
        mapView.onCreate(savedInstanceState);// 此方法必须重写

//        ToolBarOptions options = new NimToolBarOptions();
////        setToolBar(R.id.toolbar, options);
        onInitSetBack(this);
        onInitRightSure(this, 0, getString(R.string.send), 0);
...
//        sendButton.setText(R.string.send);
        comRightSure.setOnClickListener(this);
        comRightSure.setVisibility(View.INVISIBLE);
        pinView = findView(R.id.location_pin);
        pinInfoPanel = findView(R.id.location_info);
        ...
        btnMyLocation = findView(R.id.my_location);
...
//            setTitle(titleResID);
            onInitSetTitle(this, getString(titleResID));
        } else {
//            setTitle(R.string.my_location);
            onInitSetTitle(this, getString(R.string.my_location));
        }
    }
