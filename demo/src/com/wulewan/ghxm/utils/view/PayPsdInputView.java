...
public class PayPsdInputView extends EditText {
     ...
     * 分割线的颜色
     */
    private int borderColor = 0xFFF6F6F6;
    /**
     * 分割线的画笔
     */
    ...
    private int focusedColor = 0x00000000;
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        maxCount = typedArray.getInt(R.styleable.PayPsdInputView_maxCount1, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdInputView_circleColor1, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputView_bottomLineColor1, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_radius1, radius);

        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputView_divideLineWidth1, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdInputView_divideLineColor1, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdInputView_psdType1, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_rectAngle1, rectAngle);
        focusedColor = typedArray.getColor(R.styleable.PayPsdInputView_focusedColor1, focusedColor);
