package com.wulewan.ghxm.share;
...
import com.netease.wulewan.uikit.common.util.AppManager;
...
import static com.netease.wulewan.uikit.api.StatisticsConstants.SHAERGAMERECORD;
        ...
        RequestCallback requestCallback = new RequestCallback<CreateTeamResult>() {
            ...
            public void onFailed(int code) {
                ...
                if (code == ResponseCode.RES_TEAM_ECOUNT_LIMIT) {
                    tip = getString(com.netease.wulewan.uikit.R.string.over_team_member_capacity,
                            200);
                } else if (code == ResponseCode.RES_TEAM_LIMIT) {
                    tip = getString(com.netease.wulewan.uikit.R.string.over_team_capacity);
                } else {
                    tip = getString(com.netease.wulewan.uikit.R.string.create_team_failed) + ", code=" + code;
                }
