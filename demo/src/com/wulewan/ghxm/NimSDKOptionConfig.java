...
import com.netease.wulewan.uikit.api.wrapper.MessageRevokeTip;
import com.netease.wulewan.uikit.api.wrapper.NimUserInfoProvider;
import com.netease.wulewan.uikit.business.session.viewholder.MsgViewHolderThumbBase;
...
//        options.mNosTokenSceneConfig = createNosTokenScene();
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.theme_color);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.wulewan.ghxm/raw/msg";
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // 小米推送
        config.xmAppId = "2882303761518018100";
        config.xmAppKey = "5651801879100";
        config.xmCertificateName = "wlwXiaoMiPush";

        // 华为推送
        config.hwCertificateName = "wlwHuaWeiPush";

        // 魅族推送
        config.mzAppId = "121164";
        config.mzAppKey = "54af0c125bc44830b8295afdc63be544";
        config.mzCertificateName = "wlwMeiZuPush";
