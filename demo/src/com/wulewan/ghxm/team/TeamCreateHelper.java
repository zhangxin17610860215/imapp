...
import static com.netease.wulewan.uikit.api.StatisticsConstants.TEAM_MANAGER_CREATETEANSUCCESS;
...
public class TeamCreateHelper {
    ...
    public static void createNormalTeam(final Context context, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<CreateTeamResult> callback) {
        ...
        DialogMaker.showProgressDialog(context, context.getString(com.netease.wulewan.uikit.R.string.empty), true);
        // 创建群
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (failedAccounts != null && !failedAccounts.isEmpty()) {
                            ...
                            ToastHelper.showToast(DemoCache.getContext(), com.netease.wulewan.uikit.R.string.create_team_success);
                        }
...
//                            SessionHelper.startTeamSession(context, result.getTeam().getId(), MainActivity.class, null); // 进入创建的群
                    ...
                    public void onFailed(int code) {
                        ...
                        if (code == ResponseCode.RES_TEAM_ECOUNT_LIMIT) {
                            String tip = context.getString(com.netease.wulewan.uikit.R.string.over_team_member_capacity, DEFAULT_TEAM_CAPACITY);
                            ToastHelper.showToast(DemoCache.getContext(), tip);
                        } else {
                            ToastHelper.showToast(DemoCache.getContext(), com.netease.wulewan.uikit.R.string.create_team_failed);
                        }
        ...
        if (requestCallback == null)
        {
            requestCallback =  new RequestCallback<CreateTeamResult>() {
                ...
                public void onFailed(int code) {
                    ...
                    String tip;
                    if (code == ResponseCode.RES_TEAM_ECOUNT_LIMIT) {
                        tip = context.getString(com.netease.wulewan.uikit.R.string.over_team_member_capacity,
                                DEFAULT_TEAM_CAPACITY);
                    } else if (code == ResponseCode.RES_TEAM_LIMIT) {
                        tip = context.getString(com.netease.wulewan.uikit.R.string.over_team_capacity);
                    } else {
                        tip = context.getString(com.netease.wulewan.uikit.R.string.create_team_failed) + ", code=" + code;
                    }
