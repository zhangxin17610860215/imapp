...
public class TeamAVChatAction extends AVChatAction {
    ...
    private ContactSelectActivity.Option getContactSelectOption(String teamId) {
        ...
        option.title = NimUIKit.getContext().getString(com.netease.wulewan.uikit.R.string.invite_member);
        option.maxSelectedTip = NimUIKit.getContext().getString(com.netease.wulewan.uikit.R.string.reach_capacity);
