...
//            其它	其它支付错误
            ...
            switch (payResult.getResultStatus()) {
                case "9000":
                    ...
                    break;
                case "8000":
                    ToastUtil.showToast(context,"正在处理中");
                    break;
                case "4000":
                    ToastUtil.showToast(context,"订单支付失败");
                    break;
                case "5000":
                    ToastUtil.showToast(context,"重复请求");
                    break;
                case "6001":
                    ToastUtil.showToast(context,"已取消支付");
                    break;
                case "6002":
    ...
    public void goAliPay(final String tradeType, final int opt, final String rid, final String money, final String targetIds,
                         final String targetType, final String name, final String paymentPwd,
                         final String number, final String targetId, final Activity mContext, final AlipayListener mListener){
        ...
        DialogMaker.showProgressDialog(mContext, null, false);
