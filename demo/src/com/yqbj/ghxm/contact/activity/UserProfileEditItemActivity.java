    ...
    private void setTitles() {
        switch (key) {
            case UserConstant.KEY_NICKNAME:
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.nickname));
                break;
            case UserConstant.KEY_PHONE:
//                setTitle(R.string.phone_number);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.phone_number));
                editText.setInputType(InputType.TYPE_CLASS_NUMBER);
                break;
            case UserConstant.KEY_EMAIL:
//                setTitle(R.string.email);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.email));
                break;
            case UserConstant.KEY_SIGNATURE:
//                setTitle(R.string.signature);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.signature));
                break;
            case UserConstant.KEY_GENDER:
//                setTitle(R.string.gender);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.gender));
                break;
            case UserConstant.KEY_BIRTH:
//                setTitle(R.string.birthday);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.birthday));
                break;
            case UserConstant.KEY_ALIAS:
                setTitle(R.string.alias);
                onInitSetTitle(UserProfileEditItemActivity.this, getString(R.string.alias));
                break;
        }
    }
...
//            editText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(10)});
        ...
        if (key == UserConstant.KEY_ALIAS) {
            ...
            if (!TextUtils.isEmpty(alias)) {
                ...
                UserInfo userInfo = NimUIKit.getUserInfoProvider().getUserInfo(data);
...
//        toolbarView.setText(R.string.save);
        onInitRightSure(this, 0, getString(R.string.save), 0);
        if (comRightSure != null) {
        ...
        RequestCallbackWrapper callback = new RequestCallbackWrapper() {
            ...
            public void onResult(int code, Object result, Throwable exception) {
                ...
                if (code == ResponseCode.RES_SUCCESS) {
                    ...
                    ToastHelper.showToast(UserProfileEditItemActivity.this, R.string.Invalid_format);
                }
            }
        };
        if (key == UserConstant.KEY_ALIAS) {
            ...
            if (key == UserConstant.KEY_EMAIL) {
                if (StringUtil.checkMail((String) content) == false)
                {
                    ToastHelper.showToast(UserProfileEditItemActivity.this, R.string.Invalid_format);
                    return;
                }
