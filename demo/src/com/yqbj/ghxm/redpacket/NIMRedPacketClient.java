...
import com.yqbj.ghxm.redpacket.privateredpacket.GroupRedPacketActivity;
...
import static com.yqbj.ghxm.config.Constants.BUILDREDSTRUCTURE.REDPACKET_COUNT;
...
import static com.yqbj.ghxm.config.Constants.BUILDREDSTRUCTURE.REDPACKET_RECEIVER;
import static com.yqbj.ghxm.config.Constants.BUILDREDSTRUCTURE.REDPACKET_SENDER;
import static com.yqbj.ghxm.config.Constants.BUILDREDSTRUCTURE.REDPACKET_SENDERID;
 ...
 * 4.红包消息、拆红包消息分别使用自定义消息，参考 {@link com.yqbj.ghxm.session.extension.RedPacketAttachment}、
 * {@link com.yqbj.ghxm.session.extension.RedPacketOpenedAttachment},在调用金融魔方接口发送红包成功之后，发送
