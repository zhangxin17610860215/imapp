package com.netease.wulewan.uikit.business.recent.holder;
...
import com.netease.wulewan.uikit.business.recent.RecentContactsCallback;
...
import com.netease.wulewan.uikit.common.ui.recyclerview.adapter.BaseQuickAdapter;
import com.netease.wulewan.uikit.common.ui.recyclerview.holder.BaseViewHolder;
import com.netease.wulewan.uikit.common.ui.recyclerview.holder.RecyclerViewHolder;
...
public abstract class RecentViewHolder extends RecyclerViewHolder<BaseQuickAdapter, BaseViewHolder, RecentContact> {
    ...
    public void inflate(BaseViewHolder holder, final RecentContact recent) {
        ...
        this.imgDisturb = holder.getView(R.id.img_Disturb);
    ...
    protected void loadPortrait(RecentContact recent) {
        ...
        if (recent.getSessionType() == SessionTypeEnum.P2P) {
            UserInfo userInfo = NimUIKitImpl.getUserInfoProvider().getUserInfo(recent.getContactId());
            if (null != userInfo){
    ...
    private void updateNewIndicator(RecentContact recent) {
        final int unreadNum = recent.getUnreadCount();
