package com.netease.wulewan.uikit.business.recent;
...
import com.netease.wulewan.uikit.api.model.main.OnlineStateChangeObserver;
import com.netease.wulewan.uikit.api.model.team.TeamDataChangedObserver;
import com.netease.wulewan.uikit.api.model.team.TeamMemberDataChangedObserver;
import com.netease.wulewan.uikit.api.model.user.UserInfoObserver;
import com.netease.wulewan.uikit.business.recent.adapter.RecentContactAdapter;
...
import com.netease.wulewan.uikit.common.badger.Badger;
...
import com.netease.wulewan.uikit.common.ui.drop.DropCover;
import com.netease.wulewan.uikit.common.ui.drop.DropManager;
import com.netease.wulewan.uikit.common.ui.recyclerview.listener.SimpleClickListener;
...
import static com.netease.wulewan.uikit.common.ui.dialog.CustomAlertDialog.onSeparateItemClickListener;
...
public class RecentContactsFragment extends TFragment {
    ...
    public static final long RECENT_TAG_NEEDDISTURB = 0x0000000000000002; // 免打扰
    ...
    private SimpleClickListener<RecentContactAdapter> touchListener = new SimpleClickListener<RecentContactAdapter>() {
        ...
        public void onItemClick(RecentContactAdapter adapter, View view, int position) {
            if (callback != null) {
                ...
                if (recent.getSessionType() == SessionTypeEnum.Team) {
                    //如果是群聊，检查群主是否设置了36小时清理消息
                    inspectRegularCleanMode(recent);
                }else {
    ...
    private void getTeamConfig(final Team team, RecentContact recent) {
    ...
    private void deleteChattingHistory(final Team team, final boolean isRegularCleanMode, final long carryTime, RecentContact recent) {
    ...
    private void refreshMessages(boolean unreadChanged) {
        ...
        if (unreadChanged) {
            ...
            if (ShortcutBadger.isBadgeCounterSupported(getContext())){
                ShortcutBadger.applyCount(getContext(), unreadNum);
            }else {
                ...
                intent.putExtra("notificationNum", unreadNum);
