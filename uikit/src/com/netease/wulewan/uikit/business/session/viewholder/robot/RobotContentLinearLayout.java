...
import com.netease.wulewan.uikit.business.robot.model.RobotBotContent;
import com.netease.wulewan.uikit.business.robot.model.RobotResponseContent;
import com.netease.wulewan.uikit.business.robot.parser.elements.base.Element;
...
import com.netease.wulewan.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.netease.wulewan.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.netease.wulewan.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
