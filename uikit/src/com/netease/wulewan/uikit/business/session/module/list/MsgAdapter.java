...
import com.netease.wulewan.uikit.common.ui.recyclerview.holder.BaseViewHolder;
...
//            notifyDataSetChanged(); // 可以不要！！！
    ...
    private boolean setShowTimeFlag(IMMessage message, IMMessage anchor) {
        ...
        try {
            ...
            if (null != message && null != message.getAttachment()){
                String attachmentName = message.getAttachment().getClass().getName();
