package com.netease.wulewan.uikit.business.contact.core.util;
...
public class ContactUtil {  
    ...
    private List<MobileInfo> userList;
    ...
    public List<MobileInfo> getContactInfo(){
        if(userList!=null){
            userList.clear();
        }else{
        ...
        while (cursor.moveToNext()){
            ...
            mobileInfo.setPhoneNum(phone);
            mobileInfo.setDisplayName(name);
            userList.add(mobileInfo);
...
//            int id = cursor.getInt(cursor.getColumnIndex("_id"));
            String name = cursor.getString(cursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME));
            String phone = cursor.getString(cursor.getColumnIndex("data1"));
            LogUtil.e( context.getClass().toString(),"name = " + name);
            LogUtil.e( context.getClass().toString(),"phone = " + phone);
     ...
     */  
    public String getContactJsonInfo() throws JSONException {
    ...
    public void getAllGroupInfo() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                Log.e("MainActivity", "group id:" + groupId + ">>groupName:"
                        + groupName);
