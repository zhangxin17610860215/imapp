package com.netease.wulewan.uikit.common.ui.dialog;
...
public class EasyProgressDialog extends Dialog {
    ...
    public EasyProgressDialog(Context context, int layout, String msg) {
        this(context, R.style.app_transparent_dialog, layout);
        setMessage(msg);
    }

    public EasyProgressDialog(Context context, String msg) {
        this(context, R.style.app_transparent_dialog, R.layout.nim_easy_progress_dialog);
        setMessage(msg);
    }
