package com.netease.wulewan.uikit.common.ui.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public void loadTeamIconByTeam(Team team) {
        if(team != null)
        {
            loadTeamIconByTeam(team.getId());
        }
    }


    public void loadTeamIconByTeam(String teamId){
        String url = NimUIKit.getTeamProvider().getTeamById(teamId).getIcon();
        judgeLoadImage(url,R.drawable.nim_avatar_default,DEFAULT_AVATAR_THUMB_SIZE);
    }
...
////        DEFAULT_AVATAR_RES_ID, DEFAULT_AVATAR_THUMB_SIZE
        ...
        final HeadImageView theone = this;
        Glide.with(getContext().getApplicationContext())
                .load(DEFAULT_AVATAR_RES_ID)
                .into(this);
    }
