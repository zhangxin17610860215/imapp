package com.netease.wulewan.uikit.common.ui.widget;
...
public class SwitchButton extends View implements OnTouchListener {
    ...
    private void init() {// 初始化
        ...
        GradientDrawable gradientDrawableOn = new GradientDrawable();
        gradientDrawableOn.setShape(GradientDrawable.RECTANGLE);
        gradientDrawableOn.setColor(Color.parseColor("#859CED"));




        gradientDrawableOn.setCornerRadius(ScreenUtil.dip2px(30));

        gradientDrawableOn.setSize(ScreenUtil.dip2px(55),ScreenUtil.dip2px(30));
        gradientDrawableOn.setStroke(1,Color.parseColor("#859CED"));


        GradientDrawable gradientDrawableOff = new GradientDrawable();
        gradientDrawableOff.setColor(Color.parseColor("#C9C9CB"));
        gradientDrawableOff.setShape(GradientDrawable.RECTANGLE);
        gradientDrawableOff.setCornerRadius(ScreenUtil.dip2px(30));

        gradientDrawableOff.setSize(ScreenUtil.dip2px(55),ScreenUtil.dip2px(30));
        gradientDrawableOff.setStroke(1,Color.parseColor("#C9C9CB"));



        GradientDrawable gradientDrawableSlip = new GradientDrawable();
        gradientDrawableSlip.setColor(Color.parseColor("#FFFFFF"));

        gradientDrawableSlip.setShape(GradientDrawable.OVAL);

        gradientDrawableSlip.setStroke(1,Color.parseColor("#C9C9CB"));

        gradientDrawableSlip.setCornerRadius(ScreenUtil.dip2px(15));

        gradientDrawableSlip.setSize(ScreenUtil.dip2px(30),ScreenUtil.dip2px(30));

        bg_on = ImageUtil.drawableToBitmap(gradientDrawableOn);
        bg_off = ImageUtil.drawableToBitmap(gradientDrawableOff);
        slip_btn = ImageUtil.drawableToBitmap(gradientDrawableSlip);
