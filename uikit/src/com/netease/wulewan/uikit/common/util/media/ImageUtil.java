package com.netease.wulewan.uikit.common.util.media;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.netease.wulewan.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
