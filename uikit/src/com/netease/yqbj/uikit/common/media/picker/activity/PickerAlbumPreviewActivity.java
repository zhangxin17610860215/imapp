package com.netease.yqbj.uikit.common.media.picker.activity;
...
import com.netease.yqbj.uikit.business.session.constant.RequestCode;
import com.netease.yqbj.uikit.common.activity.ToolBarOptions;
import com.netease.yqbj.uikit.common.activity.UI;
import com.netease.yqbj.uikit.common.media.picker.adapter.PickerPreviewPagerAdapter;
import com.netease.yqbj.uikit.common.media.picker.model.PhotoInfo;
import com.netease.yqbj.uikit.common.media.picker.model.PickerContract;
import com.netease.yqbj.uikit.common.media.picker.util.PickerUtil;
import com.netease.yqbj.uikit.common.ui.imageview.BaseZoomableImageView;
...
public class PickerAlbumPreviewActivity extends UI implements OnClickListener, OnPageChangeListener {
    ...
    private void initActionBar() {
        previewSelectBtn = findView(R.id.picker_image_preview_photos_select);
        previewSelectBtn.setOnClickListener(this);
    }

    private void initUI() {
        previewOperationBar = findView(R.id.picker_image_preview_operator_bar);
        originalImage = findView(R.id.picker_image_preview_orignal_image);
        originalImage.setOnClickListener(this);
        originalImageSizeTip = findView(R.id.picker_image_preview_orignal_image_tip);
        if (!isSupportOriginal) {
            originalImage.setVisibility(View.INVISIBLE);
            originalImageSizeTip.setVisibility(View.INVISIBLE);
        }
        previewSendBtn = findView(R.id.picker_image_preview_send);
        previewSendBtn.setOnClickListener(this);
        updateSelectBtnStatus();
        updateOriImageSizeTip(isSendOriginalImage);

        imageViewPager = findView(R.id.picker_image_preview_viewpager);
