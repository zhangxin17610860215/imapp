package com.netease.yqbj.uikit.business.session.viewholder.robot;
...
import com.netease.yqbj.uikit.business.robot.model.RobotBotContent;
import com.netease.yqbj.uikit.business.robot.model.RobotResponseContent;
import com.netease.yqbj.uikit.business.robot.parser.elements.base.Element;
import com.netease.yqbj.uikit.business.robot.parser.elements.element.ImageElement;
import com.netease.yqbj.uikit.business.robot.parser.elements.element.TextElement;
import com.netease.yqbj.uikit.business.robot.parser.elements.group.LinkElement;
import com.netease.yqbj.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.netease.yqbj.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.netease.yqbj.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
