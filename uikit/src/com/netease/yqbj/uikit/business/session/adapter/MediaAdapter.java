package com.netease.yqbj.uikit.business.session.adapter;
...
import com.netease.yqbj.uikit.business.session.activity.WatchVideoActivity;
import com.netease.yqbj.uikit.business.session.viewholder.IMsgImage;
import com.netease.yqbj.uikit.business.session.viewholder.media.DateViewHolder;
import com.netease.yqbj.uikit.business.session.viewholder.media.MediaViewHolder;
...
public class MediaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == ITEM_VIEW_TYPE_DATE) {
            ...
            if (msg.getMsgType() == MsgTypeEnum.image || msg.getAttachment() instanceof IMsgImage) {
                ((MediaViewHolder) holder).playImage.setVisibility(View.GONE);
                FileAttachment imageAttachment = (FileAttachment) msg.getAttachment();
                String path = "";
