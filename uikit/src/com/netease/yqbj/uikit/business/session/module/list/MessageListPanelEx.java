package com.netease.yqbj.uikit.business.session.module.list;
...
import com.netease.yqbj.uikit.api.model.main.CustomPushContentProvider;
...
import com.netease.yqbj.uikit.business.robot.parser.elements.group.LinkElement;
import com.netease.yqbj.uikit.business.session.activity.VoiceTrans;
import com.netease.yqbj.uikit.business.session.audio.MessageAudioControl;
import com.netease.yqbj.uikit.business.session.helper.MessageHelper;
...
import com.netease.yqbj.uikit.business.session.viewholder.robot.RobotLinkView;
...
import com.netease.yqbj.uikit.common.ui.recyclerview.adapter.BaseFetchLoadAdapter;
import com.netease.yqbj.uikit.common.ui.recyclerview.adapter.IRecyclerView;
import com.netease.yqbj.uikit.common.ui.recyclerview.listener.OnItemClickListener;
import com.netease.yqbj.uikit.common.ui.recyclerview.loadmore.MsgListFetchLoadMoreView;
import com.netease.yqbj.uikit.common.util.media.BitmapDecoder;
import com.netease.yqbj.uikit.common.util.sys.ClipboardUtil;
                ...
                if (messages != null) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (null != imMessage.getAttachment()){
                            try {
                                Class aClass = Class.forName("com.yqbj.ghxm.session.extension.RedPacketOpenedAttachment");
