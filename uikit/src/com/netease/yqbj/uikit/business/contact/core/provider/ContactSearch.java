...
import com.netease.yqbj.uikit.business.contact.core.provider.ContactSearch.HitInfo.Type;
import com.netease.yqbj.uikit.business.contact.core.query.TextQuery;
import com.netease.yqbj.uikit.business.contact.core.query.TextSearcher;
...
public class ContactSearch {
    ...
    static boolean hitMobile(MobileInfo contact, TextQuery query) {
        String account = contact.getAccount();
