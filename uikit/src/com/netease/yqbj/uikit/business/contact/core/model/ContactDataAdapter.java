...
import com.netease.yqbj.uikit.business.contact.core.model.ContactDataTask.Host;
...
//        int index = this.viewHolderMap.indexOfKey(itemDataType);
//        if(index > 0){
//            this.viewHolderMap.setValueAt(index,viewHolder);
//        }else{
            this.viewHolderMap.delete(itemDataType);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            if (convertView == null || (holder = (AbsContactViewHolder<AbsContactItem>) convertView.getTag()) == null) {
                ...
                if (holder != null) holder.create(context);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
