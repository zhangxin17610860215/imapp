...
import com.netease.yqbj.uikit.business.session.viewholder.robot.RobotContentLinearLayout;
import com.netease.yqbj.uikit.business.session.viewholder.robot.RobotLinkViewStyle;
...
public class ChatRoomMsgViewHolderRobot extends ChatRoomMsgViewHolderText implements RobotContentLinearLayout.ClickableChildView {
    ...
    protected int getContentResId() {
        return com.netease.yqbj.uikit.R.layout.nim_message_item_robot;
    }

    @Override
    protected void inflateContentView() {
        containerIn = findViewById(com.netease.yqbj.uikit.R.id.robot_in);
        bodyTextView = containerIn.findViewById(R.id.nim_message_item_text_body);
        robotContent = findViewById(com.netease.yqbj.uikit.R.id.robot_out);
        ...
        holderFooterButton = findViewById(com.netease.yqbj.uikit.R.id.tv_robot_session_continue);
